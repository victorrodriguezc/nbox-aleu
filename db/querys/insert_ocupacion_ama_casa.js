...
exports.insert_ocupacion_ama_casa = function(input, callback){
	...
	logger.log('info', 'Se realizara la insercion en la tabla tb_ocupacion_ama_casa con la siguiente data: ' + input);

	var sql = "INSERT INTO tb_ocupacion_ama_casa (id_postulante) VALUES (?)";
