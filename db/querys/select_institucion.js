...
exports.select_institucion = function(callback){
	...
	logger.log('info', 'Se va a realizar un select a la tabla tb_institucion');

	con.query("SELECT * FROM tb_institucion", function (err, result, fields) {
