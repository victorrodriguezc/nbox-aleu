...
exports.insert_ocupacion_independiente = function(input, callback){
	...
	logger.log('info', 'Se realizara la insercion en la tabla tb_ocupacion_independiente con la siguiente data: ' + input);

	var sql = "INSERT INTO tb_ocupacion_independiente (id_postulante, ruc, id_ingresos_mensuales) VALUES (?, ?, ?)";
