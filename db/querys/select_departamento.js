...
exports.select_departamento = function(callback){
	...
	logger.log('info', 'Se va a realizar un select a la tabla tb_departamento');

	con.query("SELECT * FROM tb_departamento", function (err, result, fields) {
